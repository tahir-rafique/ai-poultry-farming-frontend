    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        <h1 className="page-title flex items-center gap-2">
          <Syringe size={24} className="text-primary-600" /> Vaccination & Care
          Schedule
        </h1>
        <p className="text-gray-500 text-sm mt-0.5">
          Standard 42-day broiler management protocol
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          <h2 className="section-title flex items-center gap-2">
            <Syringe size={18} className="text-primary-500" /> Vaccination
            Timeline
          </h2>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p
                      className={`font-semibold text-sm ${done ? "line-through text-gray-400" : "text-gray-800"}`}
                    >
                      {v.vaccine_name}
                    </p>
      ...
      <div className="card p-4 bg-blue-50 border-blue-200 text-sm text-blue-800">
        <strong>Tip:</strong> Click on a vaccination card to mark it as
        completed. The schedule follows standard Pakistan broiler farming
        practices. Consult a vet for region-specific adjustments.
      </div>
    </div>
  );
}
